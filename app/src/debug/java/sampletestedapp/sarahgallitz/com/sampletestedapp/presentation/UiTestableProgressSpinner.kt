...
class UiTestableProgressSpinner(context: Context, attrs: AttributeSet) : ProgressBar(context, attrs) {
    override fun setIndeterminateDrawable(drawable: Drawable) {
        ...
        super.setIndeterminateDrawable(if (hideIndeterminateDrawable) getDrawable(context, R.drawable.loading_spinner_non_animated) else drawable)
    }
}
